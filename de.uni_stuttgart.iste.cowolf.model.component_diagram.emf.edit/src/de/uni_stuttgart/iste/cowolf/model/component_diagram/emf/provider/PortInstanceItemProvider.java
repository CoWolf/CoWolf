...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.component_diagram.PortInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_diagramPackage.Literals.PORT_INSTANCE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addConnectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortInstance_connect_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortInstance_connect_feature", "_UI_PortInstance_type"),
				 Component_diagramPackage.Literals.PORT_INSTANCE__CONNECT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_diagramPackage.Literals.PORT_INSTANCE__TYPE,
				 true,
				 false,
				 true,
				 null,
