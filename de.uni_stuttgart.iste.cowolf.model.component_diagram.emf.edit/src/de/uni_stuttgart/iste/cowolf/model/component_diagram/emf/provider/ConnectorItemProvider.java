...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.component_diagram.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_diagramPackage.Literals.CONNECTOR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_port_feature", "_UI_Connector_type"),
				 Component_diagramPackage.Literals.CONNECTOR__PORT,
				 true,
				 false,
				 true,
				 null,
