...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.component_diagram.PortType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortTypeItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPort_instancePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_diagramPackage.Literals.PORT_TYPE__NAME,
				 true,
				 false,
				 false,
	 ...
	 * @generated
	 */
	protected void addPort_instancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortType_port_instance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortType_port_instance_feature", "_UI_PortType_type"),
				 Component_diagramPackage.Literals.PORT_TYPE__PORT_INSTANCE,
				 true,
				 false,
				 true,
				 null,
