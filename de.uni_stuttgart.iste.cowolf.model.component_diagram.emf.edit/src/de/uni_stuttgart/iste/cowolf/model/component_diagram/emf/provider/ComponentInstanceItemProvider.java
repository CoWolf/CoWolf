...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.component_diagram.ComponentInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentInstanceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_diagramPackage.Literals.COMPONENT_INSTANCE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_diagramPackage.Literals.COMPONENT_INSTANCE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentInstance_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentInstance_version_feature", "_UI_ComponentInstance_type"),
				 Component_diagramPackage.Literals.COMPONENT_INSTANCE__VERSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Component_diagramPackage.Literals.COMPONENT_INSTANCE__SUBCOMPONENT);
			childrenFeatures.add(Component_diagramPackage.Literals.COMPONENT_INSTANCE__IN_PORTS);
			childrenFeatures.add(Component_diagramPackage.Literals.COMPONENT_INSTANCE__OUT_PORTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Component_diagramPackage.Literals.COMPONENT_INSTANCE__SUBCOMPONENT,
				 Component_diagramFactory.eINSTANCE.createComponentInstance()));

		newChildDescriptors.add
			(createChildParameter
				(Component_diagramPackage.Literals.COMPONENT_INSTANCE__IN_PORTS,
				 Component_diagramFactory.eINSTANCE.createPortInstance()));

		newChildDescriptors.add
			(createChildParameter
				(Component_diagramPackage.Literals.COMPONENT_INSTANCE__OUT_PORTS,
				 Component_diagramFactory.eINSTANCE.createPortInstance()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Component_diagramPackage.Literals.COMPONENT_INSTANCE__IN_PORTS ||
			childFeature == Component_diagramPackage.Literals.COMPONENT_INSTANCE__OUT_PORTS;
