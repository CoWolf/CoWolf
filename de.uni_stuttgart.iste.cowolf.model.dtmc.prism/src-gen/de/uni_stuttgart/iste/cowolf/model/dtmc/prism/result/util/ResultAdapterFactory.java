/**
 */
package de.uni_stuttgart.iste.cowolf.model.dtmc.prism.result.util;
 ...
 * <!-- end-user-doc -->
 * @see de.uni_stuttgart.iste.cowolf.model.dtmc.prism.result.ResultPackage
 * @generated
 */
public class ResultAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.uni_stuttgart.iste.cowolf.model.dtmc.prism.result.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.uni_stuttgart.iste.cowolf.model.dtmc.prism.result.Greeting <em>Greeting</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
