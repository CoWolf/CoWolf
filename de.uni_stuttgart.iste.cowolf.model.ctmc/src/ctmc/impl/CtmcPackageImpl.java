...
import ctmc.CtmcFactory;
import ctmc.CtmcPackage;
import ctmc.Label;
import ctmc.State;
import ctmc.Transition;

import ctmc.util.CtmcValidator;
...
public class CtmcPackageImpl extends EPackageImpl implements CtmcPackage {
	 ...
	 * @generated
	 */
	public EReference getCTMC_Transitions() {
		return (EReference)ctmcEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(ctmcEClass, CTMC__TRANSITIONS);
	...
	public void initializePackageContents() {
		...
		initEClass(ctmcEClass, ctmc.CTMC.class, "CTMC", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCTMC_Name(), ecorePackage.getEString(), "name", "", 0, 1, ctmc.CTMC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCTMC_States(), this.getState(), null, "States", null, 0, -1, ctmc.CTMC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCTMC_InitialState(), this.getState(), null, "initialState", null, 1, 1, ctmc.CTMC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCTMC_Transitions(), this.getTransition(), null, "Transitions", null, 0, -1, ctmc.CTMC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
