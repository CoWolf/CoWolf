...
public class TransformationWizardPage extends WizardPage {
	...
	public void createControl(final Composite parent) {
		...
		modelAChooser.addSelectionListener(this.browseWorkspace(
				this.wizard.getSourceModelA(), labelA, parent.getShell()));
		...
		modelBChooser.addSelectionListener(this.browseWorkspace(
				this.wizard.getSourceModelB(), labelB, parent.getShell()));
		...
		modelCChooser.addSelectionListener(this.browseWorkspace(
				this.wizard.getTargetModel(), labelC, parent.getShell()));
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (files.length >= 1) {
					...
					if (originalModel != null
							&& originalModel.equals(wizard.getSourceModelA())) {
