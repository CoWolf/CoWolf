...
/**
 * This is the item provider adapter for a {@link sequence.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider extends ContainerItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SequencePackage.Literals.BLOCK__INCLUDES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Block.class)) {
			case SequencePackage.BLOCK__INCLUDES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SequencePackage.Literals.BLOCK__INCLUDES,
		...
		newChildDescriptors.add
			(createChildParameter
				(SequencePackage.Literals.BLOCK__INCLUDES,
				 SequenceFactory.eINSTANCE.createBlockBase()));
	}
