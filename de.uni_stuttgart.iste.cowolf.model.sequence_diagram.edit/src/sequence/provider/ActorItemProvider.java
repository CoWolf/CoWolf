...
/**
 * This is the item provider adapter for a {@link sequence.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SequencePackage.Literals.ACTOR__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SequencePackage.Literals.ACTOR__INITIAL_MESSAGES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Actor.class)) {
			case SequencePackage.ACTOR__NAME:
				...
				return;
			case SequencePackage.ACTOR__INITIAL_MESSAGES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SequencePackage.Literals.ACTOR__INITIAL_MESSAGES,
				 SequenceFactory.eINSTANCE.createInitialMessage()));
	}
