...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.sequence_diagram.Alternative} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlternativeItemProvider extends BlockItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alternative_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alternative_condition_feature", "_UI_Alternative_type"),
				 Sequence_diagramPackage.Literals.ALTERNATIVE__CONDITION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Alternative.class)) {
			case Sequence_diagramPackage.ALTERNATIVE__CONDITION:
