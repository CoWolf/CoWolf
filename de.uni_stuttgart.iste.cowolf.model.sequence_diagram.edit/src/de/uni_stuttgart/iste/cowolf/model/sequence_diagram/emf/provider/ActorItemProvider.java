 ...
 * @generated
 */
public class ActorItemProvider extends IDBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sequence_diagramPackage.Literals.ACTOR__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Sequence_diagramPackage.Literals.ACTOR__INITIAL_MESSAGES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Actor.class)) {
			case Sequence_diagramPackage.ACTOR__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Sequence_diagramPackage.ACTOR__INITIAL_MESSAGES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Sequence_diagramPackage.Literals.ACTOR__INITIAL_MESSAGES,
				 Sequence_diagramFactory.eINSTANCE.createInitialMessage()));
	}
