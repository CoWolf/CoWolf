...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.sequence_diagram.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends IDBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sequence_diagramPackage.Literals.TASK__LIFELINE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sequence_diagramPackage.Literals.TASK__IN,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Sequence_diagramPackage.Literals.TASK__OUTGOING_MESSAGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Sequence_diagramPackage.Literals.TASK__OUTGOING_MESSAGES,
				 Sequence_diagramFactory.eINSTANCE.createSpecialMessage()));

		newChildDescriptors.add
			(createChildParameter
				(Sequence_diagramPackage.Literals.TASK__OUTGOING_MESSAGES,
				 Sequence_diagramFactory.eINSTANCE.createNormalMessage()));
	}
