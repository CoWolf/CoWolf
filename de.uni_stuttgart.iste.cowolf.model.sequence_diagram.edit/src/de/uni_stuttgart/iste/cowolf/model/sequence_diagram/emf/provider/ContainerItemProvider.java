...
import de.uni_stuttgart.iste.cowolf.model.sequence_diagram.Container;
...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.sequence_diagram.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider extends IDBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_messages_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_messages_feature", "_UI_Container_type"),
				 Sequence_diagramPackage.Literals.CONTAINER__MESSAGES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTasksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_tasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_tasks_feature", "_UI_Container_type"),
				 Sequence_diagramPackage.Literals.CONTAINER__TASKS,
				 true,
				 false,
				 true,
				 null,
