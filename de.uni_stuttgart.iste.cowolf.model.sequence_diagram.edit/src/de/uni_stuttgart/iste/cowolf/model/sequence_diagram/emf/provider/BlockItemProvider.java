...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.sequence_diagram.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockItemProvider extends ContainerItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Sequence_diagramPackage.Literals.BLOCK__INCLUDES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Block.class)) {
			case Sequence_diagramPackage.BLOCK__INCLUDES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Sequence_diagramPackage.Literals.BLOCK__INCLUDES,
		...
		newChildDescriptors.add
			(createChildParameter
				(Sequence_diagramPackage.Literals.BLOCK__INCLUDES,
				 Sequence_diagramFactory.eINSTANCE.createBlockBase()));
	}
