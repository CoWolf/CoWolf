...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.Decision} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DecisionItemProvider extends NodesWithoutJoinItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Decision_outgoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Decision_outgoing_feature", "_UI_Decision_type"),
				 Activity_diagramPackage.Literals.DECISION__OUTGOING,
				 true,
				 false,
				 true,
				 null,
