...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.JoinArrow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JoinArrowItemProvider extends IDBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Activity_diagramPackage.Literals.JOIN_ARROW__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Activity_diagramPackage.Literals.JOIN_ARROW__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((JoinArrow)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_JoinArrow_type") :
			getString("_UI_JoinArrow_type") + " " + label;
	}
