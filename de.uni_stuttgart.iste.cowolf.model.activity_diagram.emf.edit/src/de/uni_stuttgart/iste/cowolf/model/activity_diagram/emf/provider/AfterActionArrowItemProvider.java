...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.AfterActionArrow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AfterActionArrowItemProvider extends IDBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Activity_diagramPackage.Literals.AFTER_ACTION_ARROW__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((AfterActionArrow)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AfterActionArrow_type") :
			getString("_UI_AfterActionArrow_type") + " " + label;
	}
