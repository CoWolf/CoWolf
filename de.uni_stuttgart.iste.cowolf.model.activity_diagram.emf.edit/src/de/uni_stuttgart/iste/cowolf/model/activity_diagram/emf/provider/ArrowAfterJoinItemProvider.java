...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.ArrowAfterJoin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrowAfterJoinItemProvider extends IDBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Activity_diagramPackage.Literals.ARROW_AFTER_JOIN__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((ArrowAfterJoin)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ArrowAfterJoin_type") :
			getString("_UI_ArrowAfterJoin_type") + " " + label;
	}
