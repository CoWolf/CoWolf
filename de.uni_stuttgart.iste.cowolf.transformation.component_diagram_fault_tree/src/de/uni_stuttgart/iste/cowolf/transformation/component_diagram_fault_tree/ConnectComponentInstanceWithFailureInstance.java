 ...
 * "ConnectComponentInstanceWithFailureInstance".
 * 
 * @version 1.01 14 December 2013
 * @author Yannic Noller
 * 
 */
public class ConnectComponentInstanceWithFailureInstance {
	...
	/**
	 * Executes the rule "ConnectComponentInstanceWithFailureInstance" with the given
	 * parameter.
	 * 
	 * @param input
	 *            - String name of file
	...
	public static void run(Resource sa, Resource ft, String component_instance, String failure_instance) {
		...
		HenshinTransformations.connectComponentInstanceWithFailureInstance(component_instance, failure_instance, saGraph, true);
