...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>activity</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.activity"));
				Root root = ActivityFactory.eINSTANCE.createRoot();
