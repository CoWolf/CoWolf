...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sequence_diagram</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class Sequence_diagramExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new Sequence_diagramResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(Sequence_diagramPackage.eNS_URI, 
			 Sequence_diagramPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				de.uni_stuttgart.iste.cowolf.model.sequence_diagram.Package root = Sequence_diagramFactory.eINSTANCE.createPackage();
