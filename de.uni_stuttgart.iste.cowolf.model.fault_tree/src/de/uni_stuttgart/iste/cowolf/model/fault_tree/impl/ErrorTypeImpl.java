...
public class ErrorTypeImpl extends EObjectImpl implements ErrorType {
	...
	public void setRoot(Root newRoot) {
		if (newRoot != eInternalContainer() || (eContainerFeatureID() != FaultTreePackage.ERROR_TYPE__ROOT && newRoot != null)) {
			...
			if (newRoot != null)
				msgs = ((InternalEObject)newRoot).eInverseAdd(this, FaultTreePackage.ROOT__ERROR_TYPE, Root.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FaultTreePackage.ERROR_TYPE__ROOT:
				return eInternalContainer().eInverseRemove(this, FaultTreePackage.ROOT__ERROR_TYPE, Root.class, msgs);
		}
