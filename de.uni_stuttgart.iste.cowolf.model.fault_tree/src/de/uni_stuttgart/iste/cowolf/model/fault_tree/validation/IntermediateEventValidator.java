...
/**
 * A sample validator interface for {@link de.uni_stuttgart.iste.cowolf.model.fault_tree.IntermediateEvent}.
...
public interface IntermediateEventValidator {
	...
	boolean validateInEvent(Event value);
	boolean validateOutEvent(Event value);
}
