...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.SingleActivityListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SingleActivityListTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((SingleActivityListType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SingleActivityListType_type") :
			getString("_UI_SingleActivityListType_type") + " " + label;
	}
