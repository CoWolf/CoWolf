...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.PlotControlType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlotControlTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((PlotControlType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_PlotControlType_type") :
			getString("_UI_PlotControlType_type") + " " + label;
	}
