...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.ActivityGraphBase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityGraphBaseItemProvider extends IDBaseItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ActivityGraphBase)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ActivityGraphBase_type") :
			getString("_UI_ActivityGraphBase_type") + " " + label;
	}
