...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.ActivityListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityListTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ActivityListType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ActivityListType_type") :
			getString("_UI_ActivityListType_type") + " " + label;
	}
