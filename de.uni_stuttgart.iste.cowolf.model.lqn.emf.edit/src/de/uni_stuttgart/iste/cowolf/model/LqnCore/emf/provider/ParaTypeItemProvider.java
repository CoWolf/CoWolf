...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.ParaType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParaTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ParaType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ParaType_type") :
			getString("_UI_ParaType_type") + " " + label;
	}
