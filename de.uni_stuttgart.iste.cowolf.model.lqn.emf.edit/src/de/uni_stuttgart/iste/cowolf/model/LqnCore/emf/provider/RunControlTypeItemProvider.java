...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.RunControlType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RunControlTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((RunControlType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RunControlType_type") :
			getString("_UI_RunControlType_type") + " " + label;
	}
