...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.LqnCoreType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LqnCoreTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LQNPackage.Literals.LQN_CORE_TYPE__SLOT);
		}
	...
	public String getText(Object object) {
		String label = ((LqnCoreType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_LqnCoreType_type") :
			getString("_UI_LqnCoreType_type") + " " + label;
	}
