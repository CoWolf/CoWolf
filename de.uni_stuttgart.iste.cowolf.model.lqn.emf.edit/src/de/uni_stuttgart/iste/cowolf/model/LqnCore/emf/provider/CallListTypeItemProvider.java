...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.CallListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallListTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((CallListType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_CallListType_type") :
			getString("_UI_CallListType_type") + " " + label;
	}
