...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.ActivityType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityTypeItemProvider extends IDBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivityType_activity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityType_activity_feature", "_UI_ActivityType_type"),
				 LQNPackage.Literals.ACTIVITY_TYPE__ACTIVITY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((ActivityType)object).getId();
