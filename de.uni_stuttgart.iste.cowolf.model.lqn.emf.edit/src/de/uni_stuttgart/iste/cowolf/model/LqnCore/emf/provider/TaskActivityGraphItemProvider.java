...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.TaskActivityGraph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskActivityGraphItemProvider extends ActivityGraphBaseItemProvider {
	...
	public String getText(Object object) {
		String label = ((TaskActivityGraph)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TaskActivityGraph_type") :
			getString("_UI_TaskActivityGraph_type") + " " + label;
	}
