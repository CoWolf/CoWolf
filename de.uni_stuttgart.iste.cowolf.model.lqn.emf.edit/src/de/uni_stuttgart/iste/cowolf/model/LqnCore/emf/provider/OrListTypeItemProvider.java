...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.OrListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrListTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LQNPackage.Literals.OR_LIST_TYPE__ACTIVITY);
		}
	...
	public String getText(Object object) {
		String label = ((OrListType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_OrListType_type") :
			getString("_UI_OrListType_type") + " " + label;
	}
