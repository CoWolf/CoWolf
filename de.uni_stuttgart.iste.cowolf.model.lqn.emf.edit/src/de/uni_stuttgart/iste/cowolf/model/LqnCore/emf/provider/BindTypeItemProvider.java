...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.LqnCore.BindType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BindTypeItemProvider extends IDBaseItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((BindType)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_BindType_type") :
			getString("_UI_BindType_type") + " " + label;
	}
