...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ctmc</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CtmcExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ctmc"));
				CTMC root = CtmcFactory.eINSTANCE.createCTMC();
