 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.impl.SplitArrowImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SplitArrowImpl extends IDBaseImpl implements SplitArrow {
	...
	protected EClass eStaticClass() {
		return Activity_diagramPackage.Literals.SPLIT_ARROW;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Activity_diagramPackage.SPLIT_ARROW__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(NodesWithoutJoin newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Activity_diagramPackage.SPLIT_ARROW__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Activity_diagramPackage.SPLIT_ARROW__TARGET:
