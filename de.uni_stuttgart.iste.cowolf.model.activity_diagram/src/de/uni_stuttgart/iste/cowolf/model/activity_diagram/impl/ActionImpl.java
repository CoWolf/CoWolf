 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.impl.ActionImpl#getAction <em>Action</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.impl.ActionImpl#getOutgoing <em>Outgoing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionImpl extends NodesWithoutJoinImpl implements Action {
	...
	protected EClass eStaticClass() {
		return Activity_diagramPackage.Literals.ACTION;
	}
	...
	public void setAction(String newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Activity_diagramPackage.ACTION__ACTION, oldAction, action));
	}
	...
	public AfterActionArrow getOutgoing() {
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Activity_diagramPackage.ACTION__OUTGOING, oldOutgoing, outgoing));
			}
		}
		return outgoing;
	}
	...
	public void setOutgoing(AfterActionArrow newOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Activity_diagramPackage.ACTION__OUTGOING, oldOutgoing, outgoing));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Activity_diagramPackage.ACTION__ACTION:
				return getAction();
			case Activity_diagramPackage.ACTION__OUTGOING:
