 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.impl.JoinImpl#getOutgoing <em>Outgoing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinImpl extends NodesImpl implements Join {
	...
	protected EClass eStaticClass() {
		return Activity_diagramPackage.Literals.JOIN;
	}
		...
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Activity_diagramPackage.JOIN__OUTGOING, oldOutgoing, outgoing));
			}
		}
		return outgoing;
	}
	...
	public void setOutgoing(ArrowAfterJoin newOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Activity_diagramPackage.JOIN__OUTGOING, oldOutgoing, outgoing));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Activity_diagramPackage.JOIN__OUTGOING:
