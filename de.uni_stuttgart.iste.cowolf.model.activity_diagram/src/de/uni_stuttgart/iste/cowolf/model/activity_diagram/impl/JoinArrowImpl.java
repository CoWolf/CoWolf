 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.impl.JoinArrowImpl#getSource <em>Source</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity_diagram.impl.JoinArrowImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinArrowImpl extends IDBaseImpl implements JoinArrow {
	...
	protected EClass eStaticClass() {
		return Activity_diagramPackage.Literals.JOIN_ARROW;
	}
	...
	public EList<NodesWithoutJoin> getSource() {
		if (source == null) {
			source = new EObjectResolvingEList<NodesWithoutJoin>(NodesWithoutJoin.class, this, Activity_diagramPackage.JOIN_ARROW__SOURCE);
		}
		return source;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Activity_diagramPackage.JOIN_ARROW__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Join newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Activity_diagramPackage.JOIN_ARROW__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Activity_diagramPackage.JOIN_ARROW__SOURCE:
				return getSource();
			case Activity_diagramPackage.JOIN_ARROW__TARGET:
