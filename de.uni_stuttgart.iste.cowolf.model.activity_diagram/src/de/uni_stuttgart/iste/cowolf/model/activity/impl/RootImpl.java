 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getStart <em>Start</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getAction <em>Action</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getDecision <em>Decision</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getEnd <em>End</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getSplit <em>Split</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getJoin <em>Join</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getStartArrow <em>Start Arrow</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getAfterActionArrow <em>After Action Arrow</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getDecisionArrow <em>Decision Arrow</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getSplitArrow <em>Split Arrow</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getJoinArrow <em>Join Arrow</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.activity.impl.RootImpl#getArrowAfterJoin <em>Arrow After Join</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
