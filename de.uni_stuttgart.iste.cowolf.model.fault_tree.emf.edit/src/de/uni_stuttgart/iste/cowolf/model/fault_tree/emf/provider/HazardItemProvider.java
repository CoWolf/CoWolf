...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.fault_tree.Hazard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HazardItemProvider extends EventItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hazard_inEvent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hazard_inEvent_feature", "_UI_Hazard_type"),
				 FaultTreePackage.Literals.HAZARD__IN_EVENT,
				 true,
				 false,
				 true,
				 null,
