...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.fault_tree.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends IDBaseItemProvider {
	/**
	...
	protected void addInputGatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_inputGate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_inputGate_feature", "_UI_Event_type"),
				 FaultTreePackage.Literals.EVENT__INPUT_GATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutputGatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_outputGate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_outputGate_feature", "_UI_Event_type"),
				 FaultTreePackage.Literals.EVENT__OUTPUT_GATE,
				 true,
				 false,
				 true,
				 null,
