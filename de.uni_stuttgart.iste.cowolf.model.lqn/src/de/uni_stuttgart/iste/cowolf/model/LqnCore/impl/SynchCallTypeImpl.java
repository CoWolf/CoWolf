 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.SynchCallTypeImpl#getDest <em>Dest</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.SynchCallTypeImpl#getFanin <em>Fanin</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.SynchCallTypeImpl#getFanout <em>Fanout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SynchCallTypeImpl extends IDBaseImpl implements SynchCallType {
	/**
	...
	public void setFanin(int newFanin) {
		...
		faninESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LQNPackage.SYNCH_CALL_TYPE__FANIN, oldFanin, fanin, !oldFaninESet));
	}
	...
	public void unsetFanin() {
		...
		faninESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LQNPackage.SYNCH_CALL_TYPE__FANIN, oldFanin, FANIN_EDEFAULT, oldFaninESet));
	}
	...
	public void setFanout(int newFanout) {
		...
		fanoutESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LQNPackage.SYNCH_CALL_TYPE__FANOUT, oldFanout, fanout, !oldFanoutESet));
	}
	...
	public void unsetFanout() {
		...
		fanoutESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LQNPackage.SYNCH_CALL_TYPE__FANOUT, oldFanout, FANOUT_EDEFAULT, oldFanoutESet));
	}
