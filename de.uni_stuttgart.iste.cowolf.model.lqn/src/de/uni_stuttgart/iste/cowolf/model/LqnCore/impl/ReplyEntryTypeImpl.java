 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.ReplyEntryTypeImpl#getReplyActivity <em>Reply Activity</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.ReplyEntryTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReplyEntryTypeImpl extends IDBaseImpl implements ReplyEntryType {
	/**
	...
	public EList<ReplyActivityType> getReplyActivity() {
		if (replyActivity == null) {
			replyActivity = new EObjectContainmentEList<ReplyActivityType>(ReplyActivityType.class, this, LQNPackage.REPLY_ENTRY_TYPE__REPLY_ACTIVITY);
		}
