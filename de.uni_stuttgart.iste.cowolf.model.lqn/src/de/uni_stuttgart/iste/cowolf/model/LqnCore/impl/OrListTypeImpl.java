 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.OrListTypeImpl#getActivity <em>Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OrListTypeImpl extends IDBaseImpl implements OrListType {
	/**
	...
	public EList<ActivityOrType> getActivity() {
		if (activity == null) {
			activity = new EObjectContainmentEList<ActivityOrType>(ActivityOrType.class, this, LQNPackage.OR_LIST_TYPE__ACTIVITY);
		}
		return activity;
	}
