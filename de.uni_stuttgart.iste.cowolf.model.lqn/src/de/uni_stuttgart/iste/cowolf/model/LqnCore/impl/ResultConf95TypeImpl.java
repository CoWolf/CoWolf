 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.ResultConf95TypeImpl#getJoinVariance <em>Join Variance</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.ResultConf95TypeImpl#getJoinWaiting <em>Join Waiting</em>}</li>
 *   <li>{@link de.uni_stuttgart.iste.cowolf.model.LqnCore.impl.ResultConf95TypeImpl#getWaiting <em>Waiting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ResultConf95TypeImpl extends IDBaseImpl implements ResultConf95Type {
	/**
	...
	public void setJoinVariance(Object newJoinVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LQNPackage.RESULT_CONF95_TYPE__JOIN_VARIANCE, oldJoinVariance, joinVariance));
	}
	...
	public void setJoinWaiting(Object newJoinWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LQNPackage.RESULT_CONF95_TYPE__JOIN_WAITING, oldJoinWaiting, joinWaiting));
	}
	...
	public void setWaiting(Object newWaiting) {
		...
		waiting = newWaiting;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LQNPackage.RESULT_CONF95_TYPE__WAITING, oldWaiting, waiting));
	}
