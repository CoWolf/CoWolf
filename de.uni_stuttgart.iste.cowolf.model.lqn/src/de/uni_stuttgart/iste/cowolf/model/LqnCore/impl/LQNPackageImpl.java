...
public class LQNPackageImpl extends EPackageImpl implements LQNPackage {
	 ...
	 * @generated
	 */
	public EReference getActivityType_Activity() {
	 ...
	 * @generated
	 */
	public EReference getMakingCallType_Dest() {
		return (EReference)makingCallTypeEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(activityTypeEClass, ACTIVITY_TYPE__ACTIVITY);
		...
		createEReference(makingCallTypeEClass, MAKING_CALL_TYPE__DEST);
	...
	public void initializePackageContents() {
		...
		initEReference(getActivityType_Activity(), this.getActivityDefType(), null, "activity", null, 0, 1, ActivityType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLQN_LqnCore(), this.getLqnCoreType(), null, "lqnCore", null, 0, 1, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getLQN_LqnModel(), this.getLqnModelType(), null, "lqnModel", null, 0, 1, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMakingCallType_Dest(), this.getEntryType(), null, "dest", null, 1, 1, MakingCallType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (entryTypeEClass, 
		   source, 
		   new String[] {
			 "constraints", "PH1PH2EntryTypeDefinedWithPhases GraphEntryTypeDefinedWithGraph"
		   });
	}
