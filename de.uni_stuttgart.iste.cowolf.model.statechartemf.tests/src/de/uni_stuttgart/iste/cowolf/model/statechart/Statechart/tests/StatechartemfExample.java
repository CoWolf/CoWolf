...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>Statechart</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class StatechartemfExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(StatechartemfPackage.eNS_URI, 
			 StatechartemfPackage.eINSTANCE);
