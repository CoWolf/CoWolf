...
public class ComponentDiagramImpl extends IDBaseImpl implements ComponentDiagram {
	...
	protected EClass eStaticClass() {
		return Component_diagramPackage.Literals.COMPONENT_DIAGRAM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Component_diagramPackage.COMPONENT_DIAGRAM__NAME, oldName, name));
	}
	...
	public EList<Component> getComponetContainer() {
		if (componetContainer == null) {
			componetContainer = new EObjectContainmentWithInverseEList<Component>(Component.class, this, Component_diagramPackage.COMPONENT_DIAGRAM__COMPONET_CONTAINER, Component_diagramPackage.COMPONENT__DIAGRAM);
		}
	...
	public EList<Interface> getInterfaceContainer() {
		if (interfaceContainer == null) {
			interfaceContainer = new EObjectContainmentEList<Interface>(Interface.class, this, Component_diagramPackage.COMPONENT_DIAGRAM__INTERFACE_CONTAINER);
		}
	...
	public EList<Dependency> getDependencyContainer() {
		if (dependencyContainer == null) {
			dependencyContainer = new EObjectContainmentEList<Dependency>(Dependency.class, this, Component_diagramPackage.COMPONENT_DIAGRAM__DEPENDENCY_CONTAINER);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NameBase.class) {
			switch (derivedFeatureID) {
				case Component_diagramPackage.COMPONENT_DIAGRAM__NAME: return CommonBasePackage.NAME_BASE__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NameBase.class) {
			switch (baseFeatureID) {
				case CommonBasePackage.NAME_BASE__NAME: return Component_diagramPackage.COMPONENT_DIAGRAM__NAME;
				default: return -1;
			}
		}
