...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>fault_tree</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FaultTreeExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.faulttree"));
				Hazard root = FaultTreeFactory.eINSTANCE.createHazard();
