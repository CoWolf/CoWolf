...
public class StatemachineActionBarContributor
	...
	public StatemachineActionBarContributor() {
		...
		liveValidationAction = new DiagnosticDecorator.LiveValidator.LiveValidationAction(StatemachineEditorPlugin.getPlugin().getDialogSettings());
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(StatemachineEditorPlugin.INSTANCE.getString("_UI_StatemachineEditor_menu"), "de.uni_stuttgart.iste.cowolf.model.statechartMenuID");
