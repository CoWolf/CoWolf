...
public class RefreshActionProvider extends CommonActionProvider {
    ...
    protected void makeActions() {
        ...
        refreshAction.setDisabledImageDescriptor(getImageDescriptor("icons/logo_wulf_15x15.png"));//$NON-NLS-1$
        refreshAction.setImageDescriptor(getImageDescriptor("icons/logo_wulf_15x15.png"));//$NON-NLS-1$
