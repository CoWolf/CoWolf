 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.ieste.cowolf.model.Statechart.impl.CompositeStateImpl#getSubVertexes <em>Sub Vertexes</em>}</li>
 *   <li>{@link de.uni_stuttgart.ieste.cowolf.model.Statechart.impl.CompositeStateImpl#isIsConcurrent <em>Is Concurrent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeStateImpl extends StateImpl implements CompositeState {
	...
	protected EClass eStaticClass() {
		return statchartemfPackage.Literals.COMPOSITE_STATE;
	}
	...
	public EList<StateVertex> getSubVertexes() {
		if (subVertexes == null) {
			subVertexes = new EObjectContainmentWithInverseEList<StateVertex>(StateVertex.class, this, statchartemfPackage.COMPOSITE_STATE__SUB_VERTEXES, statchartemfPackage.STATE_VERTEX__SV_CONTAINER);
		}
		return subVertexes;
	}
	...
	public void setIsConcurrent(boolean newIsConcurrent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, statchartemfPackage.COMPOSITE_STATE__IS_CONCURRENT, oldIsConcurrent, isConcurrent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case statchartemfPackage.COMPOSITE_STATE__SUB_VERTEXES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case statchartemfPackage.COMPOSITE_STATE__IS_CONCURRENT:
