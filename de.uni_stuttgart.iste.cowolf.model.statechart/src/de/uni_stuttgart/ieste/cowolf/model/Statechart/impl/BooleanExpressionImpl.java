 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.ieste.cowolf.model.Statechart.impl.BooleanExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanExpressionImpl extends MinimalEObjectImpl.Container implements BooleanExpression {
	...
	protected EClass eStaticClass() {
		return statchartemfPackage.Literals.BOOLEAN_EXPRESSION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, statchartemfPackage.BOOLEAN_EXPRESSION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case statchartemfPackage.BOOLEAN_EXPRESSION__VALUE:
				return getValue();
		}
