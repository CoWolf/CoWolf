 ...
 * <ul>
 *   <li>{@link de.uni_stuttgart.ieste.cowolf.model.Statechart.impl.StateImpl#getState_container <em>State container</em>}</li>
 *   <li>{@link de.uni_stuttgart.ieste.cowolf.model.Statechart.impl.StateImpl#getInternalTransitions <em>Internal Transitions</em>}</li>
 *   <li>{@link de.uni_stuttgart.ieste.cowolf.model.Statechart.impl.StateImpl#getDeferrableEvents <em>Deferrable Events</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends StateVertexImpl implements State {
	...
	protected EClass eStaticClass() {
		return statchartemfPackage.Literals.STATE;
	}
	...
	public StateMachine getState_container() {
		if (eContainerFeatureID() != statchartemfPackage.STATE__STATE_CONTAINER) return null;
	...
	public NotificationChain basicSetState_container(StateMachine newState_container, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newState_container, statchartemfPackage.STATE__STATE_CONTAINER, msgs);
		return msgs;
	}
	...
	public void setState_container(StateMachine newState_container) {
		if (newState_container != eInternalContainer() || (eContainerFeatureID() != statchartemfPackage.STATE__STATE_CONTAINER && newState_container != null)) {
			...
			if (newState_container != null)
				msgs = ((InternalEObject)newState_container).eInverseAdd(this, statchartemfPackage.STATE_MACHINE__TOP, StateMachine.class, msgs);
			msgs = basicSetState_container(newState_container, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, statchartemfPackage.STATE__STATE_CONTAINER, newState_container, newState_container));
	}
	...
	public EList<Transition> getInternalTransitions() {
		if (internalTransitions == null) {
			internalTransitions = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this, statchartemfPackage.STATE__INTERNAL_TRANSITIONS, statchartemfPackage.TRANSITION__TRANS_SCONTAINER);
		}
	...
	public EList<Event> getDeferrableEvents() {
		if (deferrableEvents == null) {
			deferrableEvents = new EObjectWithInverseResolvingEList.ManyInverse<Event>(Event.class, this, statchartemfPackage.STATE__DEFERRABLE_EVENTS, statchartemfPackage.EVENT__TARGETS);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case statchartemfPackage.STATE__STATE_CONTAINER:
				return eInternalContainer().eInverseRemove(this, statchartemfPackage.STATE_MACHINE__TOP, StateMachine.class, msgs);
		}
