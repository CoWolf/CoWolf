...
import de.uni_stuttgart.ieste.cowolf.model.Statechart.statchartemfFactory;
 ...
 * @generated
 */
public class statchartemfPackageImpl extends EPackageImpl implements statchartemfPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.uni_stuttgart.ieste.cowolf.model.Statechart.statchartemfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private statchartemfPackageImpl() {
		super(eNS_URI, statchartemfFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link statchartemfPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static statchartemfPackage init() {
		if (isInited) return (statchartemfPackage)EPackage.Registry.INSTANCE.getEPackage(statchartemfPackage.eNS_URI);

		// Obtain or create and register package
		statchartemfPackageImpl thestatchartemfPackage = (statchartemfPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof statchartemfPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new statchartemfPackageImpl());

		isInited = true;

		// Create package meta-data objects
		thestatchartemfPackage.createPackageContents();

		// Initialize created meta-data
		thestatchartemfPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thestatchartemfPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(statchartemfPackage.eNS_URI, thestatchartemfPackage);
		return thestatchartemfPackage;
	}
	 ...
	 * @generated
	 */
	public statchartemfFactory getstatchartemfFactory() {
		return (statchartemfFactory)getEFactoryInstance();
	}
