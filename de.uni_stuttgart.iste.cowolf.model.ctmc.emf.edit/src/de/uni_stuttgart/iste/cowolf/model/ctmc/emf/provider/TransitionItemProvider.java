...
/**
 * This is the item provider adapter for a {@link de.uni_stuttgart.iste.cowolf.model.ctmc.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CtmcPackage.Literals.TRANSITION__FROM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CtmcPackage.Literals.TRANSITION__TO,
				 true,
				 false,
				 true,
				 null,
