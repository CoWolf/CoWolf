...
public class SequencePackageImpl extends EPackageImpl implements SequencePackage {
	 ...
	 * @generated
	 */
	public EReference getSequence_Element() {
	 ...
	 * @generated
	 */
	public EReference getSequence_Block() {
	 ...
	 * @generated
	 */
	public EReference getLifeline_Task() {
	 ...
	 * @generated
	 */
	public EReference getLoopBlock_Include() {
		return (EReference)loopBlockEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getAlternative_Includes() {
	...
	public void createPackageContents() {
		...
		createEReference(sequenceEClass, SEQUENCE__ELEMENT);
		createEReference(sequenceEClass, SEQUENCE__BLOCK);

		elementEClass = createEClass(ELEMENT);

		lifelineEClass = createEClass(LIFELINE);
		createEAttribute(lifelineEClass, LIFELINE__NAME);
		createEReference(lifelineEClass, LIFELINE__TASK);
		...
		createEReference(loopBlockEClass, LOOP_BLOCK__INCLUDE);

		altBlockEClass = createEClass(ALT_BLOCK);
		createEReference(altBlockEClass, ALT_BLOCK__ALTERNATIVE);

		alternativeEClass = createEClass(ALTERNATIVE);
		createEReference(alternativeEClass, ALTERNATIVE__INCLUDES);
	...
	public void initializePackageContents() {
		...
		altBlockEClass.getESuperTypes().add(this.getBlock());

		// Initialize classes, features, and operations; add parameters
		initEClass(sequenceEClass, Sequence.class, "Sequence", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSequence_Element(), this.getElement(), null, "element", null, 0, -1, Sequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSequence_Block(), this.getBlock(), null, "block", null, 0, -1, Sequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLifeline_Task(), this.getTask(), null, "task", null, 0, -1, Lifeline.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMessage_From(), this.getTask(), null, "from", null, 1, 1, Message.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMessage_To(), this.getTask(), null, "to", null, 1, 1, Message.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(taskEClass, Task.class, "Task", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTask_Outgoing(), this.getMessage(), null, "outgoing", null, 0, -1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTask_Incoming(), this.getMessage(), null, "incoming", null, 0, -1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLoopBlock_Include(), this.getElement(), null, "include", null, 0, -1, LoopBlock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAlternative_Includes(), this.getElement(), null, "includes", null, 0, -1, Alternative.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
