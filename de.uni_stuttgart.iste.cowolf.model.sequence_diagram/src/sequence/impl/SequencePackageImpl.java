...
import sequence.MessageSortSpecial;
...
public class SequencePackageImpl extends EPackageImpl implements SequencePackage {
	...
	public void initializePackageContents() {
		...
		initEClass(containerEClass, sequence.Container.class, "Container", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Messages(), this.getMessage(), this.getMessage_In(), "messages", null, 0, -1, sequence.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Tasks(), this.getTask(), this.getTask_In(), "tasks", null, 0, -1, sequence.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
