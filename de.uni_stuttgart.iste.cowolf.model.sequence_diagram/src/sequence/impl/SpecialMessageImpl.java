 ...
 * <ul>
 *   <li>{@link sequence.impl.SpecialMessageImpl#getTo <em>To</em>}</li>
 *   <li>{@link sequence.impl.SpecialMessageImpl#getMessageSort <em>Message Sort</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpecialMessageImpl extends MessageImpl implements SpecialMessage {
	...
	protected EClass eStaticClass() {
		return SequencePackage.Literals.SPECIAL_MESSAGE;
	}
		...
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SequencePackage.SPECIAL_MESSAGE__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(Lifeline newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SequencePackage.SPECIAL_MESSAGE__TO, oldTo, to));
	}
	...
	public void setMessageSort(MessageSortSpecial newMessageSort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SequencePackage.SPECIAL_MESSAGE__MESSAGE_SORT, oldMessageSort, messageSort));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SequencePackage.SPECIAL_MESSAGE__TO:
